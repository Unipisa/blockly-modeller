...
AI-based features support the model generation through three components: a diagram reader, contextual hints and textual instructions.

<img width="1392" alt="simple_scheme_modeller (2)" src="layout-modeller.png">
